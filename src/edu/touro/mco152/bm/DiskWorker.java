 ...
 *
 * TODO: Decouple the class from Swing by creating an interface which can be implemented to run the program from
 * various sources
 */
...
public class DiskWorker extends SwingWorker<Boolean, DiskMark> {
    ...
    /**
     * Runs in background to keep track of a particular Disk Benchmark. This does most of the work of this class.
     * @return
     * @throws Exception
     */
    @Override
